...
Function .onInit
  ...
  System::Call 'kernel32::CreateMutexW(p 0, i 1, w "NextExamTeacherPortableMutex") p.r0 ?e'
...
already_running:
  MessageBox MB_OK|MB_ICONEXCLAMATION "Next-Exam Teacher is already running!"
