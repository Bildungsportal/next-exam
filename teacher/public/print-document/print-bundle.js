...
// public/print-document/print-entry.mjs
__webpack_exports__GlobalWorkerOptions.workerSrc = new URL("./pdf.worker.mjs", import.meta.url).href;
var PRINT_RENDER_SCALE = 1.5;
async function rasterPdfToPrintPages(uint8) {
  const pdf = await __webpack_exports__getDocument({ data: uint8 }).promise;
  const pages = [];
