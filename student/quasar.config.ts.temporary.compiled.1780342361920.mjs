...
import fs from "fs";
var __quasar_inject_import_meta_url__ = "file:///Users/valueerror/GIT/next-exam/student/quasar.config.ts";
    ...
    electron: {
      ...
      builder: {
        ...
        extraResources: [
          ...
          ...["assessment-helper", "wifi-helper"].filter((name) => fse.existsSync(path.join(__dirname, "scripts/apple", name))).map((name) => ({ from: `scripts/apple/${name}`, to: `apple/${name}` }))
        ],
        ...
        mac: {
          ...
          ...macUsesAacProvisionProfile() ? { provisioningProfile: "scripts/apple/nextexamstudent.provisionprofile" } : {},
