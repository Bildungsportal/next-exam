...
export default {
    ...
    setup() {
        ...
        let {examtype, servername, servertoken, serverip, token, clientname, serverstatus, pincode, localLockdown, online, battery, wlanInfo, entrytime} = storeToRefs(infoStore);
