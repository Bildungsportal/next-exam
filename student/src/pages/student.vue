...
export default {
    ...
    setup() {
      let {development, version, serverApiPort, electron, info, buildDate, hostip, bipIntegration, bipApiUrl, bipDemo} = storeToRefs(useConfigStore());
    ...
    methods: {
        ...
        async loginBiP() {
            ...
            let IPCresponse = window.ipcRenderer.sendSync('loginBiP', isIOS() ? this.bipApiUrl : this.biptest)
