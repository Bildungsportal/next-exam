    ...
    <div class="column nx-rdp-root" style="height: 100%; position: relative;">
        ...
        <div id="toolbar" class="d-inline p-1 pt-0">
            ...
            <div v-for="file in localfiles" :key="file.name" class="d-inline" style="text-align:left">
                ...
                <div v-if="(file.type == 'image')" class="btn btn-info p-0 pe-2 ps-1 me-1 mb-0 btn-sm"
                     @click="selectedFile=file.name; loadImage(file.name)"><img src="/img/svg/eye-fill.svg"
                                                                                class="white" width="22" height="22"
                                                                                style="vertical-align: top;">
                    {{ file.name }}
                </div>
        ...
        <div id="content">
            ...
            <div style="height:100%" width="100%" ref="container">
                <webview v-if="!isIOSPlatform" ref="wvmain" :src="rdpUrl" style="height:100%; width:100%;"></webview>
                <div v-else ref="nativeSlot" style="height:100%; width:100%;"></div>
            </div>
            <!-- RDP Viewer end -->
...
export default {
    ...
    setup() {
        ...
        return { development, serverApiPort, electron, hostip, isIOSPlatform: isIOS(),
    ...
    methods: {
        ...
        reloadWebview() {
            if (isIOS()) {
                WebViewBox.reload({url: this.rdpUrl});
                return;
            }
            const webview = this.$refs.wvmain;
        ...
        async fetchInfo() {
            ...
            if (urlChanged && this.rdpUrl) {
                if (isIOS()) await WebViewBox.reload({url: this.rdpUrl});
                else if (this.$refs.wvmain) this.$refs.wvmain.setAttribute('src', this.rdpUrl);
            }
        ...
        // Opens the iOS RD Web Client in the renderer placeholder.
        async openNativeBrowser() {
            if (!this.rdpUrl || !this.$refs.nativeSlot) return;
        ...
        // Keeps the native RDP view aligned after rotation or resize.
        ...
        // Hides native RDP while a material preview is open.
