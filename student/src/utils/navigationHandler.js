...
class NavigationHandler {
    ...
    createBiPLoginWin(biptest) {
        ...
        const loginUrl = this.config.bipDemo ? this.config.demoBipLoginUrl : this.config.bipLoginUrl
        this.bipwindow.loadURL(biptest === true || biptest === 'true' ? loginUrl.replace('//www.', '//q.') : loginUrl)
