...
## Debian - Lockscreen
Unter Debian (gnome/wayland) kann im abgesicherten Modus der Lockscreen nicht genutzt werden.

## WLAN-Info
Unter macOS kann die WLAN-Information nicht abgerufen werden.  
Unter Windows tritt dieses Verhalten ebenfalls auf, wenn die Standortberechtigung nicht erteilt wurde.
