...
/** Request header carrying HMAC proof (Moodle: HTTP_X_NEXT_EXAM_STUDENT_MOODLE_PROOF). */
export const NEXT_EXAM_MOODLE_PROOF_HEADER = 'X-Next-Exam-Student-Moodle-Proof';
