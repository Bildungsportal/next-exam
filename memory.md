...
TECH^submissionSign^pades^shared/submissionPdfSign.js+shared/package.json; getSignPdfClient require@signpdf/signpdf; scrypt+forge P12; salt OU NXE-SALT:; state enabled|skipAsk; ask each submit unless enabled or skipAsk; teacher verify IPC^student+teacher
