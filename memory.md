...
RULE^win32^kioskStartUi^StartPins=ProgramData .lnk+%ALLUSERSPROFILE% or desktopAppId(Get-StartApps); ConfigureStartPins hive+applyWindowsKioskStartPinsAtLogon HKCU; kiosk-launcher-apps.json+student.vue bar; Lenovo sidebar=OEM not our pin
