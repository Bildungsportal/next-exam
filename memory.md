...
RULE^win32^kioskAllowedAppsDrift^readKioskSystemAllowedApps uses LayoutModification.xml (%LOCALAPPDATA%\\Microsoft\\Windows\\Shell) for live Start pins + HKLM AssignedAccessConfiguration\\Profiles\\{9A2A490F-10F6-4764-974A-43B19E722C23}\\AllowedApps via reg.exe /s; NOT MDM CSP; diff vs kiosk-launcher-apps.json→notInLauncherJson; skip internals java/javaw/disable-shortcuts/netsh/powershell/reg/whoami/next-exam-student
