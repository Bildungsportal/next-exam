...
RULE^student^appsToClose^single source platformrestrictions.js; killAppsToClose()→win/lin/mac; mac TitleCase dupes for pkill -f; never bare 'vnc' (kills vncproxy-helper); remotecheck=detect only
