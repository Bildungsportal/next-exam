...
RULE^win32^kioskStartUi^Win11 launcher=StartPins Angeheftete Kacheln not desktop; install-windows-kiosk v5:StartPins desktopAppId via Get-StartApps else desktopAppLink; skip java/javaw/disable-shortcuts pins; Taskbar false
