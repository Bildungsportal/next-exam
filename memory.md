...
RULE^win32^kioskDetect^windowsKioskSetup.js: aaProof/assignedAccessActive=readWindowsAaSessionSignals (1 PS: Get-ItemProperty HKCU RestrictRun AssignedAccess_* + MDM_AssignedAccess filter InstanceID=AssignedAccess); reg.exe bad for RestrictRun subkey; live SID whoami|reg; provisionedSid=sid===.kiosk-account-sid
