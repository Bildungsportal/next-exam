...
RULE^win32^kioskStartUi^kiosk-launcher-apps.json+student.vue cageLauncher panel (no desktop lnk); no v5:StartPins in MDM (CSP 0x80004005); AllAppsList=whitelist; cageExitWarn+window close guard
