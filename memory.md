...
RULE^win32^kioskStartUi^Win11 Angeheftete Kacheln=v5:StartPins desktopAppLink to .lnk in kiosk user Programs\Next-Exam (MS quickstart; not exe path); C:\NextExam\kiosk-assigned-access.xml debug; fresh logon after provision
