...
RULE^win32^kioskStartUi^launchers=Desktop .lnk only (skip java/javaw/disable-shortcuts); AllAppsList=whitelist; Taskbar false; hive HideRecommendedSection+NoStartMenuMorePrograms
