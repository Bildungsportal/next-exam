...
RULE^win32^kioskStartUi^StartPins desktopAppLink=absolute .lnk path JSON single \\ escape; staging C:\NextExam\kiosk-start-lnks+RunOnce sync-kiosk-start-lnks.ps1 first logon; no %USERPROFILE% in JSON; Lenovo UWP sidebar=vendor not pin
